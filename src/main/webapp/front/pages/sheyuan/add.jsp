			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<button v-if="!ro.touxiang" type="button" class="layui-btn btn-theme" id="touxiangUpload">
		            ...
		            <div class="layui-form-item" pane>
		                ...
		                <div class="layui-input-block">
		                    <select name="shezhangzhanghao" id="shezhangzhanghao" lay-filter="shezhangzhanghao" disabled >
		                        <option value="">请选择</option>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('select(shezhangzhanghao)', (data) => {
					...
					http.request('follow/shezhang/shezhangzhanghao', 'get', {
						...
						vue.detail.shezhangzhanghao=res.data.shezhangzhanghao
						vue.detail.shetuanmingcheng=res.data.shetuanmingcheng
					})
				});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('sheyuan/list', 'get', {
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('sheyuan' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
