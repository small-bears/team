	...
	<body>
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #10375e","margin":"0 0 10px 0","borderColor":"rgba(16, 55, 94, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							...
							<div class="layui-input-block">
								<img id="touxiangImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :style='{"boxShadow":"0 0 6px #10375e","borderColor":"rgba(16, 55, 94, 1)","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"1px","width":"80px","borderStyle":"solid","height":"80px"}' src="../../img/avator.png">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #10375e","margin":"0 0 10px 0","borderColor":"rgba(16, 55, 94, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							...
							<div class="layui-input-block">
								<button :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.5)","margin":"0 10px 0 0","borderColor":"#ccc","backgroundColor":"rgba(16, 55, 94, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="button" class="layui-btn btn-theme" id="touxiangUpload">
						...
						<div class="layui-form-item" :style='{"padding":"10px","boxShadow":"0 0 6px #10375e","margin":"0 0 10px 0","borderColor":"rgba(16, 55, 94, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
							...
							<div class="layui-input-block select">
								<select name="shezhangzhanghao" id="shezhangzhanghao" disabled="disabled">
									<option value="">请选择</option>
									<option v-for="(item,index) in shezhangzhanghao" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px #10375e","margin":"0 0 10px 0","borderColor":"rgba(16, 55, 94, 1)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0 0 1px 0","borderStyle":"solid"}'>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function() {
				...
				http.request(`option/shezhang/shezhangzhanghao`,'get',{},(res)=>{
					vue.shezhangzhanghao = res.data
				});
				form.on('select(shezhangzhanghao)', (data) => {
					console.log(data.value);
					http.request('follow/shezhang/shezhangzhanghao', 'get', {
						columnValue: data.value
					}, function(res) {
						jquery("#shetuanmingcheng").val(res.data.shetuanmingcheng)
					})
				});
