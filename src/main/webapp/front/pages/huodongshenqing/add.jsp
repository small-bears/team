				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.shenqingbianhao" type="text" :readonly="ro.shenqingbianhao" name="shenqingbianhao" id="shenqingbianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">活动名称：</label>
						<div class="layui-input-block">
							<input v-model="detail.huodongmingcheng" type="text" :readonly="ro.huodongmingcheng" name="huodongmingcheng" id="huodongmingcheng" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">活动时间：</label>
						<div class="layui-input-block">
							<input type="text" name="huodongshijian" id="huodongshijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">活动地点：</label>
						<div class="layui-input-block">
							<input v-model="detail.huodongdidian" type="text" :readonly="ro.huodongdidian" name="huodongdidian" id="huodongdidian" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">申请时间：</label>
						<div class="layui-input-block">
							<input type="text" name="shenqingshijian" id="shenqingshijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.dianhuahaoma" type="text" :readonly="ro.dianhuahaoma" name="dianhuahaoma" id="dianhuahaoma" autocomplete="off" class="layui-input">
						</div>
					</div>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="shenqingyuanyin" id="shenqingyuanyin">请输入申请原因</textarea>
						</div>
					</div>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				laydate.render({
					elem: '#huodongshijian'
                                ...
                                jquery('#shenqingshijian').val(getCurDateTime());
				laydate.render({
					elem: '#shenqingshijian',
					type: 'datetime'
				});
                var edit = tinymce.render({
                    elem: "#shenqingyuanyin",
                    height: 600,
				...
				http.request(`${table}/session`, 'get', {}, function(data) {
					...
					for(var key in data){
                        ...
                        if(key=='dianhuahaoma'){
                                vue.detail['dianhuahaoma'] = data[`${key}`]
                                vue.ro.dianhuahaoma = true;
                                continue;
                        }
					}
				});
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        if(o=='shenqingbianhao'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.shenqingbianhao = true;
                                                continue;
                                        }
                                        if(o=='huodongmingcheng'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.huodongmingcheng = true;
                                                continue;
                                        }
                                        if(o=='huodongshijian'){
                                                vue.detail[o] = obj[o];
                                        ...
                                        if(o=='huodongdidian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.huodongdidian = true;
                                                continue;
                                        }
                                        if(o=='shenqingshijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.shenqingshijian = true;
                                                jquery('#shenqingshijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='shenqingyuanyin'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.shenqingyuanyin = true;
                                                continue;
                                        }
				...
				form.on('submit(*)', function(data) {
					...
					var shenqingyuanyin = tinymce.get('#shenqingyuanyin').getContent()
					data.shenqingyuanyin = shenqingyuanyin;
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('huodongshenqing/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 跨表计算
                                            // 提交数据
                                            http.requestJson('huodongshenqing' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
