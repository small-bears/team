...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">社团加入管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>社团加入管理</span></li>
								<li class="breadcrumb-item active"><span>社团加入列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">社团加入列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shenqingneirongCell  = document.createElement('td');

						  if(item.shenqingneirong != null && item.shenqingneirong != "" && item.shenqingneirong.length >= 11){
			  	shenqingneirongCell.innerHTML = item.shenqingneirong.substring(0, 10) + "..."; 
			  }else{
			  	shenqingneirongCell.innerHTML = item.shenqingneirong;
			  }


			row.appendChild(shenqingneirongCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("shetuanjiaru/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("shetuanjiaru/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("shetuanjiaru/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"shetuanjiaru");
