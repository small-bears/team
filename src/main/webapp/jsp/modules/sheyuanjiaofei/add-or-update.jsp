...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑社员缴费</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>社员缴费管理</span></li>
								<li class="breadcrumb-item active"><span>编辑社员缴费</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">社员缴费信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>应缴金额</label>
										<input name="yingjiaojine" id="yingjiaojine" name="yingjiaojine" class="form-control" placeholder="应缴金额">
									</div>
									<div class="form-group col-md-6">
										<label>登记时间</label>
										<div id="dengjishijianDate" class="input-append date form_datetime">
											<input id="dengjishijian-input" name="dengjishijian" size="15" type="text" readonly>
	...
	<script>
		...
		function zhanghaoSelect2(){
			http("option/sheyuan/zhanghao","GET",{
				tableName: "sheyuan",
				columnName: "zhanghao"
			},(res)=>{
				if(res.code == 0){
		...
		function zhanghaoSelect2Change(){
			...
			http("follow/sheyuan/zhanghao","GET",{
				tableName: "sheyuan",
				columnName: "zhanghao",
				columnValue: colVal
			},(res)=>{
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "sheyuanjiaofei/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("sheyuanjiaofei/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("sheyuanjiaofei/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("sheyuanjiaofei/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#dengjishijian-input").val(getCurDate());
		...
		function calculationSE(colName){
			//单列求和接口
			http("sheyuanjiaofei"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#yingjiaojine").val(ruleForm.yingjiaojine);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yingjiaojine != null && res.data.yingjiaojine != ''){

						$("#yingjiaojine").val(res.data.yingjiaojine);
						$("#yingjiaojine").attr('readonly','readonly');
					}
