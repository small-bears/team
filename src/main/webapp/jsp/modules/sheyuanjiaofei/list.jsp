...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">社员缴费管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>社员缴费列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">社员缴费列表</h3>							
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('yingjiaojine')">应缴金额<i id="yingjiaojineIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yingjiaojineCell  = document.createElement('td');

						 yingjiaojineCell.innerHTML = item.yingjiaojine;

			row.appendChild(yingjiaojineCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("sheyuanjiaofei/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"sheyuanjiaofei");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"sheyuanjiaofei");
