							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>社长账号</label>
										<input name="shezhangzhanghao" readonly id="shezhangzhanghao" name="shezhangzhanghao" class="form-control" placeholder="社长账号">
									</div>
									<div class="form-group col-md-6">
										<label>社长姓名</label>
									...
									<div class="form-group col-md-6">
										<label>社团名称</label>
										<input name="shetuanmingcheng" readonly id="shetuanmingcheng" name="shetuanmingcheng" class="form-control" placeholder="社团名称">
									</div>
