...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20220123/b93a0964edd84e6ca656e8760de4b492.png) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<label class="label">社长账号</label> 
							<input  name="shezhangzhanghao" placeholder="社长账号" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">社长姓名</label> 
							<input  name="shezhangxingming" placeholder="社长姓名" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="dianhuahaoma" placeholder="电话号码" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "shezhang/register";
				$.ajax({ 
					type: "POST",
					url: url,
